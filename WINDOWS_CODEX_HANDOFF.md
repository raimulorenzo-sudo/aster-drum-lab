# ASTER Drum Lab v1.0.2 — Windows Codex handoff
...
- Output:
  - `dist/ASTER-Drum-Lab-1.0.2-Windows-x64-VST3.zip`
  - `dist/ASTER-Drum-Lab-1.0.2-Windows-x64-AAX.zip`
...
```text
ASTER Drum Lab v1.0.2のWindows x64版VST3とAAXをビルドし、AAXをPACE署名して、ローカルへ上書きインストールしてください。EXE、MSI、PKG、GitHub Releaseは作成しないでください。
...
3. CMakeLists.txtがVERSION 1.0.2であること、git rev-parse --abbrev-ref HEADが指定ブランチであることを確認する。
